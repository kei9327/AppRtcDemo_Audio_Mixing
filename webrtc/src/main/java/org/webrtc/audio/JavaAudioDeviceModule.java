...
public class JavaAudioDeviceModule implements AudioDeviceModule {
  ...
  public static class Builder {
    ...
    private SamplesMixAvailableCallback samplesMixAvailableCallback;
    ...
    public Builder setSamplesMixAvailableCallback(SamplesMixAvailableCallback samplesMixAvailableCallback) {
      this.samplesMixAvailableCallback = samplesMixAvailableCallback;
      return this;
    }
    ...
    public AudioDeviceModule createAudioDeviceModule() {
      ...
      final WebRtcAudioRecord audioInput = new WebRtcAudioRecord(context, audioManager, audioSource,
          audioFormat, audioRecordErrorCallback, audioRecordStateCallback, samplesReadyCallback, samplesMixAvailableCallback,
  ...
  public static class AudioSamples {
    /** See {@link AudioSamples#getAudioFormat()} */
    private final int audioFormat;
    /** See {@link AudioSamples#getChannelCount()} */
    private final int channelCount;
    /** See {@link AudioSamples#getSampleRate()} */
  ...
  public static class AudioMixSamples {
    /** See {@link AudioMixSamples#getAudioFormat()} */
    private final int audioFormat;
    /** See {@link AudioMixSamples#getChannelCount()} */
    private final int channelCount;
    /** See {@link AudioMixSamples#getSampleRate()} */
    private final int sampleRate;

    private final ByteBuffer data;

    public AudioMixSamples(int audioFormat, int channelCount, int sampleRate, ByteBuffer data) {
      this.audioFormat = audioFormat;
      this.channelCount = channelCount;
      this.sampleRate = sampleRate;
      this.data = data;
  ...
  public static interface SamplesMixAvailableCallback {
    byte[] onWebRtcAudioRecordSamplesMixAvailable(AudioMixSamples samples);
  }
