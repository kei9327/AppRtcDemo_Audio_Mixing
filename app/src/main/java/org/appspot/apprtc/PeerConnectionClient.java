...
public class PeerConnectionClient {
    ...
    @Nullable
    private BaseMixAudioController baseMixAudioController;
    ...
    public static class PeerConnectionParameters {
        ...
        public final BaseMixAudioController mixAudioController;
        ...
        public PeerConnectionParameters(boolean videoCallEnabled, boolean loopback, boolean tracing,
                                        ...
                                        BaseMixAudioController mixAudioController,
            ...
            this.mixAudioController = mixAudioController;
    ...
    private void createPeerConnectionFactoryInternal(PeerConnectionFactory.Options options) {
        ...
        baseMixAudioController = peerConnectionParameters.mixAudioController;
    ...
    AudioDeviceModule createJavaAudioDevice() {
        ...
        return JavaAudioDeviceModule.builder(appContext)
                ...
                .setSamplesMixAvailableCallback(baseMixAudioController)
    ...
    private void createPeerConnectionInternal() {
        ...
        if (baseMixAudioController != null) {
            if (baseMixAudioController.start()) {
                Log.d(TAG, "Mixing audios is activated");
            }
        }
    ...
    private void closeInternal() {
        ...
        if (baseMixAudioController != null) {
            Log.d(TAG, "Closing audio mixing process.");
            baseMixAudioController.stop();
            baseMixAudioController = null;
        }
        localRender = null;
        remoteSinks = null;
