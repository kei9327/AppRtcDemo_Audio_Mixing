...
import org.appspot.apprtc.audio.WebRTCDemoAudioMixerController;
...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        WebRTCDemoAudioMixerController mixerController = new WebRTCDemoAudioMixerController(this, true);
        mixerController.adjustBGMAudioLevel(0.2f);
        mixerController.adjustLocalAudioAudioLevel(1.0f);
